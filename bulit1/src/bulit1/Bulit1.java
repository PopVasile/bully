...
public class Bulit1 implements Runnable{
    ...
    public Bulit1(String operation) {
        this.operation = operation;

    }
    
    public Bulit1(String operation, String reqtype) {
        this.operation = operation;
    ...
    public static void main(String args[]) throws UnknownHostException, IOException, InterruptedException{
        initialize();
        Runnable receiver = new Bulit1("receiver");
        new Thread(receiver).start();
        
        // Thread.sleep(10);
        
              
        Runnable heartbeat = new Bulit1("heartbeat");
        ...
        if(operation.equals("timer")){
            ...
            try{
                ...
                if(!received){
                    ...
                    Runnable sender = new Bulit1("sender","cood");
                ...
                if(received && !leader_flag){
                    ...
                    Runnable sender = new Bulit1("sender","elecreq");
                    new Thread(sender).start(); 
                ...
                while(true){
                    ...
                    if(option.equals("elecreq")){
                        ...
                        if(self_id>source_id){
                            Runnable sender = new Bulit1("sender","ok");
                            new Thread(sender).start();
                        ...
                        if(!election_req){
                            ...
                            Runnable timer = new Bulit1("timer");
    ...
    public static void initialize() throws UnknownHostException, IOException{
        ...
        processes.put(3,"192.168.199.253");
        processes.put(2,"192.168.199.252");
        processes.put(1,"192.168.199.251");
        
        InetAddress iAddress = InetAddress.getLocalHost();
        String server_name = iAddress.getHostName();
        if(server_name.equals("192.168.199.251")){
            self_id=1;
            System.out.println("Server id here is= "+self_id);
            higher=2;
            
        }
        else if(server_name.equals("192.168.199.252")){
            self_id=2;
            System.out.println("Server id here is= "+self_id);
            higher=1;
        ...
        else if(server_name.equals("192.168.199.253")){
            self_id=3;
            System.out.println("Server id here is= "+self_id);
            higher=-1;
            Runnable sender = new Bulit1("sender","elecreq");
